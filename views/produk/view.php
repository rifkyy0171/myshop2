					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="<?=Url::base().'/'.$model->gambar_produk ?>" style="height:300px" alt="" />
								<h3>ZOOM</h3>
							</div>
						</div>
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<h2><?= $model->nama_produk ?></h2>
								<p>ID Produk = <?= $model->id_produk ?></p>
								<span>
									<span><?= $model->harga_jual ?></span>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								...
								<li><a href="#review" data-toggle="tab">Reviews (5)</a></li>
							</ul>
						</div>
						<div class="tab-content">
							<div class="tab-pane fade active in" id="details" >
                                ...
                                <div class="col-sm-12" id="reviews">
									<ul>
										<li><a href=""><i class="fa fa-user"></i>RIFKI SHOP</a></li>
									</ul>
									<p><?= $model->deskripsi ?></p>
								</div>
							</div>
