					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src=<?= Url::base().'/templates/eshopper/images/home/girl2.jpg' ?> class="girl img-responsive" alt="" />
									<img src=<?= Url::base().'/templates/eshopper/images/home/pricing.png' ?> class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src=<?= Url::base().'/templates/eshopper/images/home/girl3.jpg' ?> class="girl img-responsive" alt="" />
									<img src=<?= Url::base().'/templates/eshopper/images/home/pricing.png' ?> class="pricing" alt="" />
								</div>
							</div>
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="shipping text-center"><!--shipping-->
							<img src=<?= Url::base().'/templates/eshopper/images/home/shipping.jpg' ?> alt="" />
						</div><!--/shipping-->
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="<?=Url::base().'/'.$produk->gambar_produk  ?>" style="height:220px" alt="" />
											<!--<?= Html::img(Url::base().'/'.$produk->gambar_produk) ?>-->
								...
								<div class="item active">	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src=<?= Url::base().'/templates/eshopper/images/home/recommend1.jpg' ?> alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src=<?= Url::base().'/templates/eshopper/images/home/recommend2.jpg' ?> alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src=<?= Url::base().'/templates/eshopper/images/home/recommend3.jpg' ?> alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												</div>
